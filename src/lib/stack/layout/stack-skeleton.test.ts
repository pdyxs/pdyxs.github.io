...
import { fanSkeletonTable } from '@stack/layout/stack-skeleton';
import { fanReservationTable, reservationFor } from '@stack/layout/stack-reservation';
import { computeGeometry, STACK_GEOMETRY, type GeoParams } from '@stack/layout/stack-geometry';
