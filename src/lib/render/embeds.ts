 ...
 *
 * - `rehypeVideoEmbeds` (src/lib/render/video-embeds.ts) rewrites a bare video link
 *   in card body markdown into a responsive `<figure>`.
 * - `resolveGalleryImages` (src/lib/render/images.ts) turns an embed URL sitting in
