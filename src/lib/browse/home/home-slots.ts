...
import { BROWSE_CARD_VARIANT_NAMES, DEFAULT_BROWSE_CARD_VARIANT } from '../results/browse-card-variants.ts';
import type { BrowseCardVariantName } from '../results/browse-card-variants.ts';
