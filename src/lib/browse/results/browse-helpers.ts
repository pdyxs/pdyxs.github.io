...
import { FIVE_W_DIMENSIONS, isValidFilterValue } from '../../content/tags/five-w';
import type { FiveWDimension } from '../../content/tags/five-w';
import type { DimensionId } from '../../../dimensions/id';
import { cardOwnValues } from '../../content/cards/card-identity';
import { displayFor } from '../../content/tags/tag-display';
import type { TagDisplay } from '../../content/tags/tag-display';
import type { StatusValue } from '../../content/cards/status-visibility';
import type { FolderSort } from '../../content/folders/folder-sort';
...
export type SerialisedCard = {
  ...
  /**
   * Sequence within this card's own folder (rung 5). Crosses the wire for the
   ...
   *
   * Optional, unlike those two, because absence is MEANINGFUL here: rung 5 only
 ...
 * comparator chain (src/lib/browse/results/ranking.ts), which is what Most* Interesting is.
