...
} from '@browse/results/browse-card-variants';
 ...
 * sheets that own them: src/styles/tokens.css's `:root` spacing scale and
 * BrowseCard's own
...
const SPACE_XS = 0.375; // src/styles/tokens.css :root
const SPACE_MD = 1.25; // src/styles/tokens.css :root
