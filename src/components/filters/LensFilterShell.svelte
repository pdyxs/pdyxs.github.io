<script lang="ts">
  ...
  import { lensUid, DEFAULT_BROWSE_LENS_ID } from '@browse/lenses/lens-registry';
  import { LENS_BASE } from '@stack/state/stack-codec';
  ...
  import ActiveFilterChips from '@components/filters/ActiveFilterChips.svelte';
