<script lang="ts">
  ...
  import { collectInlineImages, isInlineBodyImage } from '@render/inline-images';
  import Lightbox from '@components/media/Lightbox.svelte';
  import type { LightboxItem } from '@components/media/Lightbox.svelte';
