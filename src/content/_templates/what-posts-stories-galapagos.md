<%*
// New card in The Galapagos Islands (what/posts/stories/galapagos).
...
await tp.file.move(`/what/posts/stories/galapagos/${slug}/index`);
-%>
---
...
#   renderer: story
#   navRenderer: series
#   location: south-america/ecuador/galapagos
---
