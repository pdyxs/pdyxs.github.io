...
These are **generated, not hand-edited** — see issue #55 for the generator that
derives them from the container folders (`_config.yaml`) and the renderer field
sets. Until that lands, this folder holds only this note.
