...
import { parseHomeSlots } from '../src/lib/browse/home/home-slots.ts';
import { LENS_BODY_KEYS, isLensBodyKey } from '../src/lib/browse/lenses/lens-body-keys.ts';
...
import type { LensDeclaration } from '../lib/browse/lenses/lens-registry.ts';
